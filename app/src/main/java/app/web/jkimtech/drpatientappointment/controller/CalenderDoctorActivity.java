...
public class CalenderDoctorActivity extends AppCompatActivity implements ITimeSlotLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender_doctor);
    ...
    private void init() {
        ...
        builder.setMessage("We are getting your appointments");
        ...
        recycler_time_slot.addItemDecoration(new GridSpacingItemDecoration(3, 8, true)); // Adjust the spacing as per your requirement
